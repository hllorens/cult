...
(function(){
    if (typeof define === 'function' && define.amd)
        define('autoComplete', function () { return autoComplete; }); // for AMD requirejs require("autoComplete")
    else if (typeof module !== 'undefined' && module.exports)
        module.exports = autoComplete; // useful for node.js - require("autoComplete")
    else
        window.autoComplete = autoComplete; // to just make it available if the file is included via javascript src=...
})();
